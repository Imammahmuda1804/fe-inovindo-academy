...
export default function MateriPage() {
      ...
      <div>
        ...
        <div className="space-y-3">
          {item.options.map((opt) => (
            <motion.label
              key={opt.id}
              className="flex items-center p-3 rounded-lg border border-gray-200 hover:bg-blue-50 cursor-pointer has-[:checked]:bg-blue-50 has-[:checked]:border-blue-400"
            ...
            >
              <input
                ...
                name={`q_${item.id}`}
                value={opt.id}
                className="w-4 h-4 mr-4 text-blue-600"
  ...
  const renderQuizResult = () => (
    <div className="p-6 text-center rounded-lg bg-slate-50">
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-green-50 flex flex-col font-['Inter'] pt-24 h-screen">
      <div className="relative flex flex-1 overflow-hidden">
        <aside
          ref={sidebarRef}
          className={`fixed inset-y-0 left-0 z-50 w-10/12 max-w-sm bg-white/50 backdrop-blur-xl border-r border-white/40 transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 lg:w-1/3 flex-shrink-0 overflow-y-auto custom-scrollbar p-8 pt-0 ${
            sidebarOpen ? "translate-x-0" : "-translate-x-full"
          }`}
        >
          <h2
            className={`text-xl font-bold text-gray-800 mb-4 sticky top-0 bg-transparent pt-8 pb-4 transition-all duration-300 ${
              sidebarScrolled
        ...
        >
          <div className="sticky top-0 z-30 lg:hidden bg-gradient-to-b from-blue-50 via-white/95 to-white/0 backdrop-blur-sm">
            <div className="px-4 py-4 border-b sm:px-6">
              <button
                onClick={() => setSidebarOpen(true)}
                className="flex items-center gap-2 px-4 py-2 font-semibold text-blue-600 rounded-lg shadow-sm bg-blue-50 hover:bg-blue-100"
              >
                <svg
          ...
          <div>
            <AnimatedContent>
              <div className="px-4 pt-4 sm:px-6 md:px-8 lg:px-16 lg:pt-8">
                ...
                <h1 className="mt-2 mb-2 text-3xl font-bold text-gray-900">
            ...
            <AnimatedContent>
              <div className="mb-6 aspect-video lg:rounded-lg lg:overflow-hidden lg:mx-16">
                <iframe
            ...
            <div className="px-4 sm:px-6 md:px-8 lg:px-16">
              <AnimatedContent>
                <div className="py-6 leading-relaxed prose text-gray-600 max-w-none">
                  <p>
                    ...
                    konsep-konsep ini akan memungkinkan Anda untuk membuat desain
                    yang tidak hanya estetis, tetapi juga efektif dalam
                    menyampaikan pesan.
                  </p>
                  ...
                  <ul className="space-y-1 list-disc list-inside">
                    <li>
                      ...
                      dalam sebuah komposisi. Kita akan membahas keseimbangan
                      simetris, asimetris, dan radial.
                    </li>
                    <li>
                      <b>Kontras (Contrast):</b> Penekanan perbedaan antara elemen
                      untuk menonjolkan bagian-bagian tertentu dan menciptakan
                      minat visual.
                    </li>
                    <li>
                      <b>Hierarki (Hierarchy):</b> Pengaturan elemen untuk
                      menunjukkan urutan kepentingannya, membimbing mata audiens
                      melalui desain secara logis.
                    </li>
                    <li>
                      <b>Pengulangan (Repetition):</b> Penggunaan kembali elemen
                      yang sama atau serupa di seluruh desain untuk menciptakan
                      konsistensi dan kesatuan.
                    </li>
                    <li>
                      <b>Kedekatan (Proximity):</b> Pengelompokan elemen-elemen
                      yang terkait untuk menciptakan hubungan visual dan
                      mengurangi kekacauan.
                    </li>
                    <li>
                      <b>White Space (Ruang Negatif):</b> Ruang kosong di sekitar
                      elemen desain. Ini penting untuk keterbacaan dan memberikan
                      "napas" pada desain.
                    </li>
                    <li>
                      <b>Kesatuan (Unity):</b> Bagaimana semua elemen dalam desain
                      bekerja sama untuk menciptakan keseluruhan yang harmonis dan
                      koheren.
                    </li>
                  </ul>
                </div>
              ...
              <div
                ...
                className="p-6 mt-8 text-center bg-white/50 backdrop-blur-lg border border-white/40 shadow-xl rounded-2xl"
              >
                ...
                <button
                  id="startQuizBtn"
                  onClick={initializeQuiz}
                  className="px-8 py-3 text-lg font-semibold text-white transition-all duration-300 rounded-lg bg-gradient-to-r from-blue-600 to-green-500 hover:scale-105 hover:shadow-xl"
                >
                  Mulai Kuis
                </button>
              </div>
              ...
              <div
                className="hidden p-6 mt-8 bg-white/50 backdrop-blur-lg border border-white/40 shadow-xl rounded-2xl"
                id="quiz-section"
              >
                ...
                <div id="quizQuestionContainer" className="min-h-[15rem]">
                  {quizFinished ? renderQuizResult() : renderCurrentQuestion()}
                </div>
                <div
                  id="quizNav"
                  className="flex flex-col items-center justify-between gap-4 mt-6 sm:flex-row sm:gap-2"
                >
                  {currentQuestionIndex > 0 && (
                    <button
                      ...
                      className="w-full px-6 py-2 font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 sm:w-auto"
                    >
                      Sebelumnya
                    </button>
                  )}
                  {currentQuestionIndex < quizData.length - 1 ? (
                    <button
                      ...
                      className="w-full px-6 py-2 font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 sm:w-auto"
                    >
                      Selanjutnya
                    </button>
                  ) : (
                    <button
                      ...
                      className="w-full px-6 py-2 font-semibold text-white rounded-lg bg-gradient-to-r from-emerald-500 to-green-500 sm:w-auto"
                    >
                      Lihat Hasil
                    </button>
                  )}
              ...
              <div
                ...
                className="p-6 mt-8 bg-white/50 backdrop-blur-lg border border-white/40 shadow-xl rounded-2xl"
              >
                  ...
                  {history.length > 0 ? (
                    history.map((attempt) => {
                      ...
                      return (
                        <div
                          key={attempt.id}
                          className="flex flex-col items-start justify-between gap-3 p-4 border border-gray-200 rounded-lg sm:flex-row sm:items-center"
                        >
                          <div>
                          ...
                          <div className="flex items-center w-full gap-4 sm:w-auto">
                            ...
                            <button
                              ...
                              className="flex-grow px-3 py-1 text-sm text-center text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200 sm:flex-grow-0"
                            >
                              Lihat Detail
                            </button>
                          </div>
              ...
              <div className="flex justify-end py-4 pt-6 mt-6">
                <button className="flex items-center px-6 py-2 space-x-2 font-semibold text-white transition-all rounded-lg bg-gradient-to-r from-emerald-500 to-blue-500 hover:scale-105 hover:shadow-xl">
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 20 20"
        ...
        >
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between p-4 border-b">
              <h3 className="text-lg font-bold">Detail Pengerjaan Kuis</h3>
              <button
              ...
              {modalContent &&
                modalContent.answers.map((ans, index) => {
                  ...
                  return (
                    <div
                      key={ans.question_id}
                      className="pb-6 mb-6 border-b last:border-b-0"
                    >
                      ...
                      <div className="space-y-2">
                        {question.options.map((opt) => {
                          ...
                          if (
                            ...
                            indicatorClass = "border-green-500 bg-green-50";
                          } else if (
                            opt.id === ans.selected_option_id &&
                            opt.id !== ans.correct_option_id
                          ) {
                            indicatorClass = "border-red-500 bg-red-50";
